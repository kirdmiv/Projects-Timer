...
class MainActivity() : ListActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
            ...
            if (!c.isAfterLast()) {
                do {
                    ...
                    if (project == null || status == null) {
                        if (project == null) {
                            Toast.makeText(ctx, "Project is null", Toast.LENGTH_SHORT).show()
                        }
                        if (status == null) {
                            Toast.makeText(ctx, "Status is null", Toast.LENGTH_SHORT).show()
                        }
                    } else {
        ...
        val addButton = findViewById<Button>(R.id.button) as Button
